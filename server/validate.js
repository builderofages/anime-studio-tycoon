/* Server-side IAP receipt validator (closes GLM-5.2 CRITICAL findings).
   Deploy as HTTPS endpoint; set VALIDATOR_URL in iap.js.
   Vercel entry: api/iap/validate.js re-exports this handler. */
