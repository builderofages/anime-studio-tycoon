  ...
  function buildHudShell() {
    ...
    shell.innerHTML = `
      <div class="hud-brand-row">
        ...
        <div class="hud-avatar-wrap" id="hud-avatar-wrap"><img class="hud-avatar" src="start-hero.png?v=87" alt=""><span class="hud-lv-badge" id="hud-lv-badge">1</span></div>
    ...
    if (!document.getElementById("pathway-rail")) {
      ...
      rail.innerHTML = `
        <img class="coach-avatar" src="https://d8j0ntlcm91z4.cloudfront.net/user_342M7OMJEmtQi5ZXBKPVqJZUjCn/hf_20260614_063644_801c60be-70bb-4a64-99db-703283d57b54.jpeg?v=87" alt="" width="40" height="40">
