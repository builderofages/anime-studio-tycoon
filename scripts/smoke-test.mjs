...
assert(html.includes("build 116"), "build 116 tag");
assert(html.includes("Production Score"), "production score label");
assert(html.includes("Polish"), "build 116 polish tag");
...
assert(html.includes("Build 116"), "what's new build 116");
assert(html.includes("Build 116 — Polish"), "what's new polish headline");
