...
assert(html.includes("build 117"), "build 117 tag");
assert(html.includes("Production Score"), "production score label");
assert(html.includes("Ship"), "build 117 ship tag");
...
assert(html.includes("Build 117"), "what's new build 117");
assert(html.includes("Build 117 — Ship"), "what's new ship headline");
...
assert(readFileSync(join(root, "strings.js"), "utf8").includes("prem_first_ribbon"), "premiere i18n keys");
