...
assert(html.includes("build 86"), "build 86 tag");
assert(html.includes("Production Score"), "production score label");
assert(html.includes("Ref Hero"), "whatsnew build 86 changelog");
