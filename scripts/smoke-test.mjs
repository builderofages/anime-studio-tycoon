...
assert(html.includes("build 97"), "build 97 tag");
assert(html.includes("Production Score"), "production score label");
assert(html.includes("Mobile"), "build 97 mobile tag");
...
assert(html.includes("Build 97"), "what's new build 97");
assert(html.includes("Build 97 — Mobile"), "what's new mobile headline");
assert(html.includes("Playtest sim"), "what's new playtest sim bullet");
assert(html.includes("iOS Safari"), "what's new ios safari bullet");
...
assert(astCss.includes("BUILD 97"), "build 97 css marker");
