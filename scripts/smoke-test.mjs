...
assert(html.includes("build 105"), "build 105 tag");
assert(html.includes("Production Score"), "production score label");
assert(html.includes("QA"), "build 105 qa tag");
...
assert(html.includes("Build 105"), "what's new build 105");
assert(html.includes("Build 105 — QA"), "what's new qa headline");
assert(html.includes("Device QA"), "what's new device qa bullet");
assert(html.includes("playtest-audit"), "what's new audit bullet");
assert(html.includes("launch-preflight"), "what's new preflight bullet");
...
assert(astCss.includes("BUILD 105"), "build 105 css marker");
