...
assert(html.includes("build 63"), "build 63 tag");
assert(html.includes("Production Score"), "production score label");
assert(html.includes("Mockup Match"), "whatsnew build 63 changelog");
assert(html.includes("aaa-greenlight-cinema"), "greenlight cinema header");
assert(html.includes("aaa-gl-carousel"), "greenlight carousel");
assert(html.includes("aaa-gl-detail"), "greenlight analytics deck");
assert(html.includes("greenlightPitchStats"), "greenlight pitch stats");
