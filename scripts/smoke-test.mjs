...
assert(html.includes("build 90"), "build 90 tag");
assert(html.includes("Production Score"), "production score label");
assert(html.includes("Guided"), "build 90 guided tag");
...
assert(html.includes("Build 90"), "what's new build 90");
...
assert(astCss.includes("BUILD 90"), "build 90 css marker");
...
assert(astLines < 3700, "ast-v5.css under 3700 lines", `${astLines} lines`);
