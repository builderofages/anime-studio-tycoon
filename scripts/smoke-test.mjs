...
assert(html.includes("build 110"), "build 110 tag");
assert(html.includes("Production Score"), "production score label");
assert(html.includes("Vanguard"), "build 110 vanguard tag");
...
assert(html.includes("Build 110"), "what's new build 110");
assert(html.includes("Build 110 — Vanguard"), "what's new vanguard headline");
assert(html.includes("1284 tests"), "what's new test count bullet");
assert(html.includes("Today's Goals"), "what's new quests bullet");
assert(html.includes("repairLoadedState"), "what's new boot repair bullet");
assert(html.includes("Grant security"), "what's new iap bullet");
