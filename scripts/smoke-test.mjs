...
assert(html.includes("build 96"), "build 96 tag");
assert(html.includes("Production Score"), "production score label");
assert(html.includes("Polish"), "build 96 polish tag");
...
assert(html.includes("Build 96"), "what's new build 96");
assert(html.includes("Build 96 — Return Hub"), "what's new return hub headline");
assert(html.includes("Return hub"), "what's new return hub bullet");
...
assert(astCss.includes("BUILD 96"), "build 96 css marker");
