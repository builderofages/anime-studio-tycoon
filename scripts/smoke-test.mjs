...
assert(html.includes("build 75"), "build 75 tag");
assert(html.includes("Production Score"), "production score label");
assert(html.includes("Mock Polish"), "whatsnew build 75 changelog");
...
assert(astCss.includes("BUILD 75"), "build 75 css marker");
