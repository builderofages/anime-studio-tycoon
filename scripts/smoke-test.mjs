...
assert(html.includes("build 101"), "build 101 tag");
assert(html.includes("Production Score"), "production score label");
assert(html.includes("Audit"), "build 101 audit tag");
...
assert(html.includes("Build 101"), "what's new build 101");
assert(html.includes("Build 101 — Audit"), "what's new audit headline");
assert(html.includes("122-check sim"), "what's new sim bullet");
assert(html.includes("Premiere queue"), "what's new premiere queue bullet");
...
assert(astCss.includes("BUILD 101"), "build 101 css marker");
