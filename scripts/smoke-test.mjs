...
assert(html.includes("build 109"), "build 109 tag");
assert(html.includes("Production Score"), "production score label");
assert(html.includes("Phalanx"), "build 109 phalanx tag");
...
assert(html.includes("Build 109"), "what's new build 109");
assert(html.includes("Build 109 — Phalanx"), "what's new phalanx headline");
assert(html.includes("1270 tests"), "what's new test count bullet");
