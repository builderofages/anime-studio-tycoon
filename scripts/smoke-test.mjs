...
assert(html.includes("build 92"), "build 92 tag");
assert(html.includes("Production Score"), "production score label");
assert(html.includes("Expand"), "build 92 expand tag");
...
assert(html.includes("Build 92"), "what's new build 92");
...
assert(astCss.includes("BUILD 92"), "build 92 css marker");
...
assert(astLines < 3900, "ast-v5.css under 3900 lines", `${astLines} lines`);
