...
assert(html.includes("build 89"), "build 89 tag");
assert(html.includes("Production Score"), "production score label");
assert(html.includes("Playable"), "build 89 playable tag");
