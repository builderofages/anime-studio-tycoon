...
assert(html.includes("build 98"), "build 98 tag");
assert(html.includes("Production Score"), "production score label");
assert(html.includes("Endgame"), "build 98 endgame tag");
...
assert(html.includes("Build 98"), "what's new build 98");
assert(html.includes("Build 98 — Endgame"), "what's new endgame headline");
assert(html.includes("Dynasty"), "what's new dynasty bullet");
assert(html.includes("Franchises"), "what's new franchise bullet");
assert(html.includes("Chaos Mode"), "what's new chaos bullet");
assert(readFileSync(join(root, "package.json"), "utf8").includes('"test:sim"'), "test:sim npm script");
assert(html.includes("Rival race"), "what's new rival race bullet");
...
assert(astCss.includes("BUILD 98"), "build 98 css marker");
