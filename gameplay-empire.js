...
(function () {
  ...
  function resolveWarRoom(idx, h) {
    ...
    if (typeof window.resetDecisionModalChrome === "function") window.resetDecisionModalChrome();
    else window.syncCrisisHudPulse?.(false);
    ...
    if (typeof h.celebrateChaosSurvival === "function") h.celebrateChaosSurvival();
